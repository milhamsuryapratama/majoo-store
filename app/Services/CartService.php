...
class CartService
{
    ...
    public static function changeQty($data)
    {
        ...
        if (!is_null($data['action']) && $data['action'] == 'plus') {
            ...
            $newCart = CartRepository::updateQty($data['product_id'],Auth::id(),'plus');
            ...
            $newCart = CartRepository::updateQty($data['product_id'],Auth::id(),'minus');
            ...
            $newCart = CartRepository::updateQty($data['product_id'],Auth::id(),'', $data['val']);
        }
